...
def test_belongs_to_matrix_square_segmentation_2x2(
    ...
    belongs_to = get_belongs_to_matrix(
        dummy_raster, square_segmentation_2x2.geometry, nodata=-1
    )

    assert_array_equal(belongs_to, expected)


def test_belongs_to_matrix_square_segmentation_3x3(
    ...
    belongs_to = get_belongs_to_matrix(
        dummy_raster, square_segmentation_3x3.geometry, nodata=-1
    )
...
def test_belongs_to_matrix_polygon_segmentation(dummy_raster, polygon_segmentation):
    ...
    belongs_to = get_belongs_to_matrix(
        dummy_raster, polygon_segmentation.geometry, nodata=-1
    )
